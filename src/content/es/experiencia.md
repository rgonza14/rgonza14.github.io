...
items:
    - title: 'Fullstack Developer — OBRAL S.A.'
      time: 'Febrero 2025 - Diciembre 2025'
      ...
      bullets:
          ...
          - Diseño e implementación de una API REST en Django para el control de stock, maquinaria y personal, integrada a un sistema utilizado por supervisores para la planificación y distribución diaria de equipos de trabajo.
